...
| :--- | :--- | :---: | :---: |
| **Retrieval Evaluation** | - Tính toán thành công Hit Rate & MRR cho ít nhất 49 test cases.<br>- Giải thích được mối liên hệ giữa Retrieval Quality và Answer Quality. |  41/49 cases | 10 |
| **Dataset & SDG** | - Golden Dataset chất lượng (49 cases) với mapping Ground Truth IDs.<br>- Có các bộ "Red Teaming" phá vỡ hệ thống thành công. |  Completed | 10 |
...
| **Performance (Async)** | - Toàn bộ pipeline chạy song song cực nhanh (< 2 phút cho 49 cases).<br>- Có báo cáo chi tiết về Cost & Token usage. | 80s/49 cases | 10 |
...
| **Ragas Relev.** | 86.94% | **91.43%** | +4.49% | Đạt |
